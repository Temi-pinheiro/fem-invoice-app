    ...
    <html lang='en' className='h-full w-full'>
      <body className='h-full w-full'>
        <div className='w-full h-full flex flex-col md:flex-row overflow-y-clip'>
          <div className='bg-gray-50 dark:bg-[#141625] h-full'>
            <nav className='md:h-screen w-full md:w-[103px] bg-[#1E2139] md:rounded-tr-lg md:rounded-br-lg flex flex-row md:flex-col'>
              ...
              <div className='ml-auto md:mt-auto md:ml-0 flex md:flex-col flex-row w-max md:w-full'>
                ...
                <span className='md:w-full px-8 md:px-0 grid place-items-center md:py-6 md:border-t border-l  md:border-l-0 border-[#494E6E]'>
                  <img
